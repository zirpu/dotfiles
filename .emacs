...
" :empty-lines-after 1))))
 ...
 '(package-selected-packages
   (quote
    (toml-mode pipenv elpy cargo apache-mode browse-kill-ring csv-mode discover erlang folding go-mode graphviz-dot-mode hcl-mode initsplit magit markdown-mode python-info python-pytest python-test pyvenv rust-mode session yaml-mode)))
