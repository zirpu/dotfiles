...
" :empty-lines-after 1)
 ...
 '(package-selected-packages
   (quote
    (zetteldeft org-random-todo use-package dockerfile-mode terraform-mode editorconfig toml-mode pipenv elpy cargo csv-mode discover folding go-mode graphviz-dot-mode hcl-mode initsplit magit markdown-mode python-info python-pytest python-test pyvenv rust-mode session yaml-mode)))
